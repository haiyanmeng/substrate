...
// extproc denial distinguishable from the CONNECT checkpoint's 403 and from
...
const DenyDetails = "extproc_egress_policy_denied"
...
//
// Request headers are deliberately absent. Its caller answers them before
// reaching here.

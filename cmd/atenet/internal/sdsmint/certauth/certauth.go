...
//
// It is not a trust anchor and must not be used as one -- Anchors is. Which CA
// signed a given leaf and which CAs a client will accept are different
// questions, and rotation is precisely the period during which they have
// different answers.
